    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scan_images', models.JSONField(blank=True, default=list, help_text='List of image file paths or URLs')),
                ('scan_files', models.JSONField(blank=True, default=list, help_text='List of additional files (PDFs, reports, etc.)')),
                ...
                ('verified_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='verified_scans', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scan_type', models.CharField(choices=[('ecg', 'ECG/EKG'), ('echo', 'Echocardiogram'), ('xray', 'X-Ray'), ('ct', 'CT Scan'), ('mri', 'MRI'), ('ultrasound', 'Ultrasound'), ('eeg', 'EEG'), ('stress_test', 'Stress Test'), ('holter', 'Holter Monitor'), ('other', 'Other')], default='ecg', max_length=50)),
